...
description: Replicate documents and attachments between databases with a version-vector protocol, in the same VM or over HTTP.
---
...
- **Provenance.** The actor/session/source a write carries (see
  [audit-provenance](/docs/guides/audit-provenance)) does not travel on the wire.
