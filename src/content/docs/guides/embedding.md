---
title: Embed barrel in an Erlang app
description: How to run barrel as an in-process document and vector database inside your Erlang release, without a server.
---
...
[record mode](/docs/guides/record-mode). The direct vector API below applies to plain
databases.
