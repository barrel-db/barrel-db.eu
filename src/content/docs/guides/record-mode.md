---
title: Record mode
description: Policy-driven vector indexing that keeps each document and its vector in sync so you get semantic and hybrid search without managing vectors.
---
