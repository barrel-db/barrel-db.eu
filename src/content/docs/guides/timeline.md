---
title: Timeline
description: Fork a database instantly (at now or rewound to a past instant), work in isolation, and merge edits back.
---
...
- A branch forks with the parent's retained history, so audit provenance
  ...
  each side's own trail. See [audit-provenance](/docs/guides/audit-provenance).
