---
title: Query with BQL
description: Query documents, vector search, and keyword search with one SELECT statement, including live subscriptions and HTTP access.
---
