---
title: MCP endpoint
description: Talk to barrel over MCP (Streamable HTTP) with tools for databases, documents, BQL, search, timeline, and the agent layer.
---
...
[audit-provenance](/docs/guides/audit-provenance).
