---
title: Spaces & agents
description: Coordinate several agents over shared context with spaces, sessions, and handoffs backed by capability tokens.
---
...
[rest-server](/docs/server/rest-server). The same operations exist as MCP tools
(`space_*`, `session_*`, `handoff_*`); see [mcp](/docs/server/mcp).
